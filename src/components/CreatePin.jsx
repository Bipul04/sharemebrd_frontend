...
const CreatePin = ({ user }) => {
    ...
    return (
        <div className='flex flex-col justify-center items-center mt-5 lg:h-4/5'>
            {fields && (
                <p className="text-red-500 mb-5 test-xl transition-all duration-150 ease-in">Please fill in all the fields.</p>
            )}
                        ...
                        <div>
                            ...
                            >
                                ...
                                {categories.map((category) => (
                                    <option className='text-base border-0 outline-none capatilize bg-white text-black' value={category.name}>{category.name}</option>
                                ))}
                            </select>
                        </div>
